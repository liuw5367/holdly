...
export default [
  ...
  layout('components/layout/app-shell.tsx', [
    ...
    route('settings/payment-accounts/new', 'routes/settings.payment-account-new.tsx'),
    route('settings/payment-accounts/:id/edit', 'routes/settings.payment-account-editor.tsx'),
